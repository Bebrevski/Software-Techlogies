...
public class ReportController {
	...
	public String createProcess(Model model, ReportBindingModel reportBindingModel) {
		...
		product.setStatus(reportBindingModel.getStatus());
		product.setMessage(reportBindingModel.getMessage());
		product.setOrigin(reportBindingModel.getOrigin());

		this.reportRepository.saveAndFlush(product);
